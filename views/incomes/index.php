<div class="page-header">
    <h1>Incomes</h1>
    <a href="<?php echo BASE_URL; ?>incomes/create" class="btn btn-success"><i class="bi bi-plus-circle"></i> Add Income</a>
</div>

<div class="card mb-4">
    <div class="card-body">
        <form method="GET" action="<?php echo BASE_URL; ?>incomes" class="row g-3">
            <div class="col-md-2">
